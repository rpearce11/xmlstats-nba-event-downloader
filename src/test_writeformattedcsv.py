...
import writeformattedcsv as csv
import codecs
import mockdata
...
class TestWriteformattedcsv(TestCase):
    ...
    def test_writeHeader(self):
        ...
        # Setup the file in the test case, so tests are isolated, as the writeformattedcsv functionality is appending writes
        self.formattedcsvwritter = csv.writeformattedcsv(self.fileName)

        self.formattedcsvwritter.writeHeader()

        header = "date,home,away,homescore,awayscore,homeq1,homeq2,homeq3,homeq4,awayq1,awayq2,awayq3,awayq4,pointspreadhome,pointspreadaway,seasonType\n"
    ...
    def test_writeSingleEventDetails(self):
        ...
        eventStrings = list()
        eventStrings.append("20130131,OKC,MEM,106,89,32,58,79,106,22,34,67,89,17,-17,regular\n")
    ...
    def test_writeMultipleEventDetails(self):
        ...
        eventStrings = list()
        eventStrings.append("20130131,OKC,MEM,106,89,32,58,79,106,22,34,67,89,17,-17,regular\n")
        eventStrings.append("20130131,GS,DAL,100,97,28,55,80,100,23,53,79,97,3,-3,regular\n")
    ...
    def test_writeSingleEventFutureDetails(self):
        ...
        self.eventDetailsWriter( mockdata.mockSingleFutureEventData, eventStrings )
