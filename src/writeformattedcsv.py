...
class writeformattedcsv():
    ...
    def writeHeader( self ):
        ...
        dataFile.write( "date,home,away,homescore,awayscore,homeq1,homeq2,homeq3,homeq4,awayq1,awayq2,awayq3,awayq4,pointspreadhome,pointspreadaway,seasonType\n" )
        dataFile.close()
    ...
    def writeEventDetails( self, eventDetails ):
        ...
        for evt in eventDetails['event']:
            ...
            # break the data down into the home team and away team for ease of handling
            ...
            self.logger.info( away_team['full_name'] + " abb:" + awayTeamAbbr + " @ " +
                              home_team['full_name'] + " abb:" + homeTeamAbbr + " " + eventStatus )
            ...
            if( eventStatus == "completed"):
                ...
                concatEventDetails = theDate + "," + homeTeamAbbr + "," + awayTeamAbbr + "," + str(homePointsScored) + "," + str(awayPointsScored) \
                                     + "," + str( homePeriodScored[0] )\
                                     + "," + str( homePeriodScored[0]+homePeriodScored[1] )\
                                     + "," + str( homePeriodScored[0]+homePeriodScored[1]+homePeriodScored[2] )\
                                     + "," + str( homePeriodScored[0]+homePeriodScored[1]+homePeriodScored[2]+homePeriodScored[3] )\
                                     + "," + str( awayPeriodScored[0] )\
                                     + "," + str( awayPeriodScored[0]+awayPeriodScored[1] )\
                                     + "," + str( awayPeriodScored[0]+awayPeriodScored[1]+awayPeriodScored[2] )\
                                     + "," + str( awayPeriodScored[0]+awayPeriodScored[1]+awayPeriodScored[2]+awayPeriodScored[3] )\
            ...
            # else log the status
                ...
                dataFile.write( theDate + "," + homeTeamAbbr + "," + awayTeamAbbr + "," + evt['event_status'] + "," + seasonType + "\n" )
